package blog.universocervejeiro.universoCervejeiro.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		...
		return new Docket(DocumentationType.SWAGGER_2)
			...
			.basePackage("blog.universocervejeiro.universoCervejeiro.controller"))
	...
	private ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
			.title("API - Blog Universo Cervejeiro")
			.description("Projeto API Spring - Blog Universo Cervejeiro")
			.version("1.0.0")
			.license("Apache License Version 2.0")
			.licenseUrl("http://github.com/andrem91")
			.contact(contact())
			.build();
	}

	private Contact contact() {
		return new Contact("André Marques",
				"https://github.com/andrem91",
