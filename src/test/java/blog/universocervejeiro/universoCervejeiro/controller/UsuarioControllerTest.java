package blog.universocervejeiro.universoCervejeiro.controller;
...
public class UsuarioControllerTest {
	...
	public void start() throws ParseException {
		...
		usuarioAdmin = new Usuario(0L, "Administrador", "admin@email.com", "admin123", dataAdmin);

		if (usuarioRepository.findByUsuario(usuarioAdmin.getUsuario()).isEmpty()) {
		...
		usuario = new Usuario(0L, "Paulo Antunes", "paulo@email.com.br", "123456", dataPost);
	...
	public void deveMostrarTodosUsuarios() {
		ResponseEntity<String> resposta = testRestTemplate.withBasicAuth("admin@email.com", "admin123")
	...
	public void deveRealizarPutUsuario() {
		...
		ResponseEntity<Usuario> resposta = testRestTemplate.withBasicAuth("admin@email.com", "admin123")
